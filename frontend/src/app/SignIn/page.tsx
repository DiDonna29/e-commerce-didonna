...
const SignIn = () => {
  ...
  return (
    <div className="bg-[#000] min-h-screen flex items-center justify-center p-4 mb-4">
      <div className="w-full max-w-[1300px] bg-[#000] rounded-3xl overflow-hidden shadow-2xl flex flex-col-reverse md:flex-row">
        {/* Right Section */}
        <div className="flex items-center w-full md:w-1/2 p-6 md:p-12">
          <div className="max-w-md mx-auto w-full">
            {" "}
            {/* Aseguramos que el contenedor sea responsivo */}
        ...
        {/* Left Section */}
        <div className="w-full md:w-1/2 relative flex items-center justify-center h-full">
          {" "}
          {/* Ajustes realizados aquí */}
          <a
            href="/"
