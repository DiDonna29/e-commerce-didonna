...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`ml-20 mr-20 p-0 mb-5 mt-5 fixed inset-x-0 top-0 z-30 transition-transform duration-300 ${
        showNavbar ? "translate-y-0" : "-translate-y-full"
      } relative overflow-hidden rounded-xl border border-blue-600/10 backdrop-blur-md bg-gradient-to-r from-blue-950 via-blue-900 to-blue-950`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute h-4 w-4 rounded-full bg-blue-400/10 animate-float top-12 left-[78%] [animation-delay:1s]"></div>
        <div className="absolute h-3 w-3 rounded-full bg-blue-400/10 animate-float top-2 left-[70%] [animation-delay:1s]"></div>
        <div className="absolute h-6 w-6 rounded-full bg-blue-400/10 animate-float top-4 left-[65%] [animation-delay:1.5s]"></div>
        <div className="absolute h-6 w-6 rounded-full bg-blue-400/10 animate-float top-6 left-[31%] [animation-delay:1.5s]"></div>
        <div className="absolute h-3 w-3 rounded-full bg-blue-400/10 animate-float top-10 left-[35%] [animation-delay:1.5s]"></div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 group">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-900 to-cyan-600 rounded-lg blur group-hover:blur-md transition-all duration-300"></div>
              <svg
          ...
          <NavLinks isLoggedIn={!!token} onLogout={logout} />
        </div>
      </div>
    </nav>
  );
